...
- **Combustion & Chemical Kinetics** — mechanism development, validation and reduction
- **Optimization & Uncertainty Quantification** — multi-stage, multi-objective calibration of Arrhenius parameters with correlated-parameter Bayesian UQ
- **Scientific Machine Learning** — neural surrogates for stiff dynamical systems
- **Computational Engineering** — an in-house CFD/multiphysics solver, and rig design for combustion experiments
