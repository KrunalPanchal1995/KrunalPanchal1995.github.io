...
permalink: /projects/
description: Optimization, uncertainty quantification, combustion kinetics, scientific ML and computational engineering — nine projects, filterable by theme.
nav: false
---

<div class="filter-bar" role="group" aria-label="Filter projects by theme">
  <button type="button" class="filter-btn active" data-filter="all">All (9)</button>
